...
export const generarIntegrado = async (token, cca, clave, expediente_id, loaderDispatch, setLoader, setPdfUrl, modalDispatch, setModal, setErrorGenerarIntegrado, errorMessagePortada) => {
    loaderDispatch(setLoader({
        showLoader: true
    }))
    try {
        const url = `${URL_API}/digitalizacion/generar-integrado/` //SELECCIONAMOS CLIENTE POR SU "id"
