...
export const handleSiguientePagina = async (token, size, pagina, loaderDispatch, setLoader, totalPaginas, expedientesDispatch, setExpedientesList, paginationDispatch, setPagination) => {
